...
\section{Turing stability analysis}
...
\section{\label{section:construction}Construction of a single mesa}
...
\section{Instabilities that develop for large $\tau$}
...
\section{Construction of the solution in the near-shadow limit}
...
\section{\label{section:stability}Stability in the near-shadow limit to perturbations in the y direction}
