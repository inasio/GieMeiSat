...
For the 1D domain $[0,L]$ we have that the eigenvalue is $k=2n\pi/L$, and the corresponding eigenvector is $W \propto \cos(n\pi x)$. Notice that the eigenvalue is not $k=n\pi/L$, as this would allow half-mesa solutions.
